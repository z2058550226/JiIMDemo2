package com.suikajy.imgpicker.adapter;
...
import com.suikajy.imgpicker.R;
import com.suikajy.imgpicker.model.AlbumInfo;
import com.suikajy.imgpicker.utils.PickerImageLoadTool;
import com.suikajy.imgpicker.utils.RotateImageViewAware;
import com.suikajy.imgpicker.utils.ThumbnailsUtil;
...
public class PickerAlbumAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.folderCover = convertView.findViewById(R.id.picker_photofolder_cover);
			viewHolder.folderName = convertView.findViewById(R.id.picker_photofolder_info);
			viewHolder.folderFileNum = convertView.findViewById(R.id.picker_photofolder_num);
