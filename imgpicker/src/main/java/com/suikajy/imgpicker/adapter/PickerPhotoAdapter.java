...
public class PickerPhotoAdapter extends BaseAdapter {
	...
	private PickerImageFragmentIP.OnPhotoSelectClickListener onPhotoSelectClickListener;
	...
	public PickerPhotoAdapter(Context context, List<PhotoInfo> list, GridView gridView,
		...
		if (onPhotoSelectClickListener == null) {
			onPhotoSelectClickListener = (PickerImageFragmentIP.OnPhotoSelectClickListener) context;
		}
	}
