package com.suikajy.imgpicker.utils;
...
public class ImageUtil {
    ...
    public static Bitmap getDefaultBitmapWhenGetFail(Context context) {
        try {
            return getBitmapImmutableCopy(context.getResources(), R.drawable.image_download_failed);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static File getScaledImageFileWithMD5(Context context, File imageFile, String mimeType) {
        ...
        String tempFilePath = getTempFilePath(context, FileUtil.getExtensionName(filePath));
    ...
    private static String getTempFilePath(Context context, String extension) {
