...
import com.suikajy.imgpicker.fragment.PickerAlbumFragmentIP;
import com.suikajy.imgpicker.fragment.PickerImageFragmentIP;
import com.suikajy.imgpicker.model.AlbumInfo;
import com.suikajy.imgpicker.model.PhotoInfo;
import com.suikajy.imgpicker.model.PickerContract;
import com.suikajy.imgpicker.utils.Extras;
import com.suikajy.imgpicker.utils.PickerConfig;
import com.suikajy.imgpicker.utils.PickerImageLoadTool;
import com.suikajy.imgpicker.utils.RequestCode;
import com.suikajy.imgpicker.view.ToolBarOptions;
import com.suikajy.imgpicker.view.UIView;
 ...
 */
public class PickerAlbumActivity extends UIView implements PickerAlbumFragmentIP.OnAlbumItemClickListener,
        PickerImageFragmentIP.OnPhotoSelectClickListener, OnClickListener {

    private FrameLayout pickerAlbumLayout;

    private FrameLayout pickerPhotosLayout;

    private PickerAlbumFragmentIP photoFolderFragment;

    private PickerImageFragmentIP photoFragment;
    ...
    private void initUI() {
        ...
        pickerPreview = findViewById(R.id.picker_bottombar_preview);
        pickerPreview.setOnClickListener(this);
        pickerSend = findViewById(R.id.picker_bottombar_select);
        pickerSend.setOnClickListener(this);

        // fragment
        pickerAlbumLayout = findViewById(R.id.picker_album_fragment);
        pickerPhotosLayout = findViewById(R.id.picker_photos_fragment);
        photoFolderFragment = new PickerAlbumFragmentIP();
    ...
    public void OnAlbumItemClick(AlbumInfo info) {
        ...
        if (photoFragment == null) {
            photoFragment = new PickerImageFragmentIP();
    ...
    public Bundle makeDataBundle(List<PhotoInfo> photos, boolean mutiMode, int mutiSelectLimitSize) {
        ...
        bundle.putSerializable(Extras.EXTRA_PHOTO_LISTS, new ArrayList<>(photos));
    ...
    public void onPhotoSingleClick(List<PhotoInfo> photos, int position) {
        if (isMutiMode) {
            ...
            if (photos != null) {
                ...
                List<PhotoInfo> selectList = new ArrayList<>();
